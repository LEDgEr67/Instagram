...
export default function HeaderOptions(props) {
  ...
  return (
    <>
      {props.showOptions && (
        <div className="absolute -right-2 bottom-10 sm:-right-3 sm:bottom-0 sm:top-8 z-100 h-48 w-60 shadow bg-white border border-gray-background rounded">
          <div className="invisible sm:visible relative float-right transform rotate-45 w-4 h-4 -bottom-2 sm:-top-1.5 sm:right-4 -z-10 bg-white border shadow border-gray-background"></div>
          <ul
            className="relative flex flex-col w-full flex-shrink-0 -top-4"
            onClick={props.handleOptions}
          >
            <Link to={`/p/${user.displayName}`}>
              <li className="flex flex-row w-full pt-2 pb-2 pl-4 pr-4 cursor-pointer hover:bg-gray-background">
                <span className="relative w-6 top-1 h-full flex items-center">
                  <svg
                    aria-label="Profile"
                    className="w-4 h-4  "
                    fill="#262626"
                ...
                <p className="text-sm relative top-0.5">Profile</p>
              </li>
            </Link>
            <li className="flex flex-row w-full pt-2 pb-2 pl-4 pr-4 cursor-pointer hover:bg-gray-background">
              <span className="relative w-6 top-1 h-full flex items-center">
              ...
              <p className="text-sm relative top-0.5">Saved</p>
            </li>
            <li className="flex flex-row w-full pt-2 pb-2 pl-4 pr-4 cursor-pointer hover:bg-gray-background">
              <span className="relative w-6 top-1 h-full flex items-center">
                <svg
              ...
              <p className="text-sm relative top-0.5">Settings</p>
            </li>
            <li className="flex flex-row w-full pt-2 pb-4 pl-4 pr-4 cursor-pointer hover:bg-gray-background">
              <span className="relative w-6 top-1 h-full flex items-center">
                <svg
              ...
              <p className="text-sm relative top-0.5">Switch Accounts</p>
            </li>
            <li
              className="flex flex-row w-full pt-2 pb-2 pl-4 pr-4 border-t border-gray-primary cursor-pointer hover:bg-gray-background"
            ...
            >
              <p className="text-sm relative top-0.5">Logout</p>
            </li>
          </ul>
        </div>
      )}
